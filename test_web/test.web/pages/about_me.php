        ...
        <div class="row">
          <section class="content__left col-md-8">
            <div class="block">
              ...
              <h3>Работа с Node.js - Программируем Marsedes AMG GT</h3>
              <div class="block__content">
                <img src="/media/images/post-image-amg.jpg">
              ...
              <div class="block__content">
                <div class="articles articles__vertical">
                  ...
                  <article class="article">
                    <div class="article__image" style="background-image: url(/media/images/post-image-amg.jpg);"></div>
