      ...
      <div class="container">
        <div class="row">
          <section class="content__left col-md-8">
            ...
            <div class="block">
              <a href="#comment-add-form">Добавление комментария</a>
              <h3>Комментарии</h3>
              <div class="block__content">
                      ...
                      ?>
                        <article class="article">
                          ...
                          <div class="article__info">
                              <a href="/article.php?id=<?php echo $art['articles_id']; ?>"><?php echo $comment['autor']; ?></a>
            ...
            <div id="comment-add-form" class="block">
              ...
              <div class="block__content">
                <from class="form" method="POST" action="/article.php?id=<?php
                  ...
                  if( isset($_POST['do_post']) )
                  {
                    ...
                    if( empty($errors) )
                    {
                      ...
                      mysqli_query($connection, "INSERT INTO `comments` (`autor`, `nickname`, `email`, `text`,`pubdate` ,`articles_id`)
                        VALUES ('".$_POST['name']."', '".$_POST['nickname']."', '".$_POST['email']."', '".$_POST['text']."', NOW(), '".$art['id']."') ");

                      echo '<span style = "color: green;font-weight: bold;>margin-bottom: 10px;display: block;">Cucessful!!</span>';
                    }
                    else
                    {
                      //Вывести ошибку
                  ...
                  <div class="form__group">
                    <textarea class="form__control" name="text" placeholder="Текст комментария ... ">
                      <?php echo $_POST['text']; ?>
                    </textarea>
                  </div>
                  <div class="form__group">
